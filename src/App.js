...
import './App.css';
import * as AnimationHelper from './helpers/animation';
...
export default class App extends React.Component {
          ...
          <div className="page-header page-header-small" filter-color="green">
            ...
            <div className="container">
              <div className="content-center">
                <div className="cc-profile-image"><a href="#header"><img src="images/anthony.jpg"  alt="place holder" /></a></div>
                ...
                <p className="category text-white">Web Developer, Graphic Designer, Photographer</p><a
                  ...
                  data-aos-anchor="data-aos-anchor">Hire Me</a><a className="btn btn-primary" href="#header" data-aos="zoom-in"
                  data-aos-anchor="data-aos-anchor">Download CV</a>
              </div>
            </div>
            <div className="section">
              <div className="container">
                <div className="button-container"><a className="btn btn-default btn-round btn-lg btn-icon" href="#header"
                    rel="tooltip" title="Follow me on Facebook"><i className="fa fa-facebook"></i></a><a
                    className="btn btn-default btn-round btn-lg btn-icon" href="#header" rel="tooltip"
  ...
  <footer className="footer">
    <div className="container text-center"><a className="cc-facebook btn btn-link" href="#header"><i className="fa fa-facebook fa-2x "
          aria-hidden="true"></i></a><a className="cc-twitter btn btn-link " href="#header"><i className="fa fa-twitter fa-2x "
          aria-hidden="true"></i></a><a className="cc-google-plus btn btn-link" href="#header"><i className="fa fa-google-plus fa-2x"
          aria-hidden="true"></i></a><a className="cc-instagram btn btn-link" href="#header"><i className="fa fa-instagram fa-2x "
